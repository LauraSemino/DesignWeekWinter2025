...
{
    //Hey! I downloaded this online, so it takes a bit of knowhow to work it.
    // Here's an example of how to play a sound:
    // AudioManager.Instance.Play(AudioManager.SoundType.SoundNameGoesHere);
    // Here's how you do music:
    // AudioManager.Instance.ChangeMusic(AudioManager.SoundType.MusicNameGoesHere);
    // ok thats all!! 
